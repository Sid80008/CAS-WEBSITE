        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="lg:w-1/2 relative group">
             ...
             <div className="absolute top-10 left-10 bg-white/20 backdrop-blur-md p-6 rounded-3xl border border-white/30 text-white max-w-xs shadow-2xl">
                <span className="text-4xl font-black block mb-2">{new Date().getFullYear() - 2013}+</span>
                <span className="text-xs font-bold tracking-widest uppercase">Years of Excellence</span>
             </div>
          </div>
