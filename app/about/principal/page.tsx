  ...
  return (
    <PublicLayout>
      <MessagePage
        ...
        message={`Dear Students, Parents, and Well-Wishers, it gives me immense pleasure to welcome you to the family of Central Academy Senior Secondary School, antah. Our school is more than a place of academic learning — it is a community dedicated to shaping the leaders of tomorrow.

At CAS antah, we believe that every child is born with unique gifts. Our responsibility as educators is to create an environment where these gifts can flourish. Our curriculum blends rigorous academics with opportunities in sports, arts, science clubs, and community service — ensuring that no talent goes unnoticed and no passion goes unnurtured.
...
To our parents: you are our partners in this journey. Your engagement, your encouragement at home, and your trust in our institution are what make the real difference. Together, we are raising not just students, but thoughtful and empathetic human beings who will make our community proud.`}
        additionalInfo="For academic guidance, admissions queries, or to schedule a meeting with the Principal's office, please contact us at +91-7737689684 or email centralacademyantah@gmail.com."
      />
    </PublicLayout>
  );
}
