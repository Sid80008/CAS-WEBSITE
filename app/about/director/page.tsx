  ...
  return (
    <PublicLayout>
      <MessagePage
        ...
        message={`Welcome to Central Academy Senior Secondary School, antah. When we founded this institution in 2013, our singular vision was clear — to build a school where every child, regardless of background, could receive a quality education that shapes both their intellect and their character.

Education is not merely a transaction of knowledge. It is a lifelong investment in a human being. At CAS antah, we have always believed that a truly educated person is one who is curious, compassionate, and capable — ready to contribute meaningfully to their community and the nation.
