...
import { updateTeacherProfile } from "@/app/actions/profileActions";
...
export default function TeacherProfileForm({ teacher, email }: TeacherProfileFormProps) {
    ...
    <div className="max-w-4xl mx-auto py-6">
      ...
      <div className="mb-8">
        ...
        <p className="font-body text-sm text-on-surface-variant mt-1">
          Update your academic staff records and password settings.
        </p>
      </div>
          ...
          <div className="relative group">
            {teacher.photo ? (
              ...
              <div className="w-24 h-24 rounded-full bg-primary-container text-white flex items-center justify-center font-bold text-3xl border-4 border-school-blue-light">
                {teacher.name ? teacher.name.split(" ").map((n) => n[0]).join("").slice(0, 2).toUpperCase() : "T"}
              </div>
            )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <section className="bg-white border border-[#E2E0DB] rounded-2xl p-6 shadow-sm space-y-4">
            <div className="flex items-center gap-2 border-b border-[#E2E0DB] pb-3 mb-2">
              ...
              <h4 className="font-h3 text-lg font-bold text-on-surface">Staff Details</h4>
            </div>
            ...
            <div className="space-y-1">
              <label className="font-label text-xs font-semibold text-on-surface-variant">Designation</label>
              <input
                name="designation"
            ...
            <div className="space-y-1">
              <label className="font-label text-xs font-semibold text-on-surface-variant">Qualification</label>
              <input
                name="qualification"
          ...
          <section className="bg-white border border-[#E2E0DB] rounded-2xl p-6 shadow-sm space-y-4">
            <div className="flex items-center gap-2 border-b border-[#E2E0DB] pb-3 mb-2">
              ...
              <h4 className="font-h3 text-lg font-bold text-on-surface">Contact Information</h4>
            </div>
            ...
            <p className="text-xs text-on-surface-variant italic">
              Email addresses and employee codes are core login credentials and can only be modified by administration.
            </p>
          </section>

          {/* Security & Password */}
          <section className="bg-white border border-[#E2E0DB] rounded-2xl p-6 shadow-sm md:col-span-2 space-y-3">
            <div className="flex items-center gap-2 border-b border-[#E2E0DB] pb-3 mb-2">
