...
export const metadata: Metadata = {
  title: "Terms of Service | Central Academy Senior Secondary School, antah",
      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100">
          ...
          <div className="prose prose-slate max-w-none prose-p:text-slate-600 prose-headings:text-slate-800">
            ...
            <p>
              All content included on this site, such as text, graphics, logos, images, and software, is the property of Central Academy antah or its content suppliers and protected by copyright laws.
            </p>

            <h2>5. Disclaimer of Warranties</h2>
            <p>
              The materials on Central Academy antah's website are provided "as is". The school makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties, including without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
            </p>

            <h2>6. Governing Law</h2>
            <p>
              Any claim relating to Central Academy antah's website shall be governed by the laws of the State of Rajasthan without regard to its conflict of law provisions.
            </p>
          </div>
        </div>
      </div>
