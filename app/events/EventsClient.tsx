            ...
            <div className="bg-white rounded-[3rem] shadow-2xl border border-slate-100 overflow-hidden grid grid-cols-1 lg:grid-cols-12">
              <div className="lg:col-span-5 bg-school-blue h-[400px] lg:h-auto relative overflow-hidden">
                ...
                <div className="absolute top-10 left-10 p-6 bg-white rounded-3xl shadow-2xl text-center min-w-[100px]">
                  <span className="block text-4xl font-black text-school-blue">
                    {format(new Date(upcomingEvents[0].date), "dd")}
                  </span>
                  <span className="block text-xs font-bold uppercase tracking-widest text-school-amber">
              ...
              <div className="lg:col-span-7 p-12 lg:p-20 flex flex-col justify-center">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-xs font-bold uppercase tracking-[0.3em] text-school-amber">
                    {language === "hi" ? "अगला बड़ा कार्यक्रम" : "Next Big Event"}
                  </span>
                </div>
                <h2
                  className={`text-4xl md:text-5xl font-bold text-school-blue mb-6 tracking-tight ${
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-16">
            <div className="space-y-4">
              <h3 className="text-4xl font-bold text-school-blue tracking-tight">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {pastEvents.slice(3, 7).map((event, i) => (
                <div
                  key={i}
                  className="bg-white p-8 rounded-3xl border border-slate-100 flex items-center justify-between group hover:shadow-xl transition-all"
                >
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <h4
                        className={`font-bold text-school-blue group-hover:text-school-amber transition-colors ${
...
function EventCard({ event, isPast, language }: { event: any; isPast?: boolean; language: string }) {
  ...
  return (
    <div
      className={`group relative bg-white rounded-[2rem] p-10 border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden ${
    ...
    >
      ...
      <div className="flex flex-col h-full">
        <div className="mb-8">
          ...
          <h3
            className={`text-2xl font-bold text-school-blue leading-tight min-h-[64px] group-hover:text-school-amber transition-colors line-clamp-2 ${
              isHindi ? "font-hindi" : ""
            }`}
          >
            {title}
