              ...
              <div className="p-8 bg-white rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50">
                ...
                <div className="flex gap-4">
                  {["FB", "IG", "LI", "YT"].map((soc) => (
                    <div
                      key={soc}
                      className="h-10 w-10 cursor-pointer rounded-xl bg-slate-50 text-school-blue flex items-center justify-center font-black text-[10px] hover:bg-school-blue hover:text-white transition-all"
                    >
                      {soc}
                    </div>
                  ))}
