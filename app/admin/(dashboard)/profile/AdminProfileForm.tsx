...
import { updateAdminProfile } from "@/app/actions/profileActions";

interface AdminProfileFormProps {
  email: string;
}

export default function AdminProfileForm({ email }: AdminProfileFormProps) {
    ...
    <div className="max-w-4xl mx-auto py-6">
      ...
      <div className="mb-8">
        ...
        <p className="font-body text-sm text-on-surface-variant mt-1">
          Update administrative account credentials and security details.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <section className="bg-white border border-[#E2E0DB] rounded-2xl p-6 shadow-sm space-y-4">
            <div className="flex items-center gap-2 border-b border-[#E2E0DB] pb-3 mb-2">
              ...
              <h4 className="font-h3 text-lg font-bold text-on-surface">Admin Credentials</h4>
            </div>
            
            <div className="space-y-1">
              <label className="font-label text-xs font-semibold text-on-surface-variant">Administrative Email</label>
              <input
                name="email"
                defaultValue={email}
                required
