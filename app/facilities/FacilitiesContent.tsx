         ...
         <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative">
               ...
               <div className="absolute top-1/2 left-0 -translate-x-1/2 -translate-y-1/2 bg-white p-8 rounded-3xl shadow-2xl border border-slate-100 max-w-xs transform -rotate-6">
                  <h4 className="text-3xl font-black text-school-blue mb-2">Safe Campus</h4>
                  <p className="text-xs font-bold text-text-tertiary uppercase tracking-widest leading-relaxed">CCTV • Trained Staff • Medical Room</p>
               </div>
            </div>
