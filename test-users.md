...
The portal login system allows logging in using alternative identifiers:
- **Student Login**: Can use the Admission Number (`CAS-2026-0001`) instead of the email address.
- **Parent Login**: Can use the Parent Phone Number (`9876543210`) instead of the email address.

---

> [!IMPORTANT]
> These credentials have been pushed directly to the PostgreSQL database and are fully active on the local environment.
