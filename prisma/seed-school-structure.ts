...
async function main() {
  ...
  // 5. Seed Toppers
  const toppersToSeed = [
    { name: 'Dwitika Sharma', class: 'Class X', year: '2025-26', percentage: 96.00, imageUrl: null },
    { name: 'Bhakti Nagar', class: 'Class X', year: '2025-26', percentage: 95.50, imageUrl: null },
    { name: 'Nipurn Malav', class: 'Class X', year: '2025-26', percentage: 95.17, imageUrl: null },
    { name: 'Kirti Prajapati', class: 'Class X', year: '2025-26', percentage: 95.00, imageUrl: null },
    { name: 'Khushi Soni', class: 'Class X', year: '2025-26', percentage: 94.83, imageUrl: null },
    { name: 'Naina Galav', class: 'Class X', year: '2025-26', percentage: 94.83, imageUrl: null },
    { name: 'Yogita Khandelwal', class: 'Class X', year: '2025-26', percentage: 94.17, imageUrl: null },
    { name: 'Hitesh Nagar', class: 'Class X', year: '2025-26', percentage: 93.83, imageUrl: null },
    { name: 'Manvi Malav', class: 'Class X', year: '2025-26', percentage: 93.33, imageUrl: null },
    { name: 'Himanshu Meena', class: 'Class X', year: '2025-26', percentage: 92.67, imageUrl: null },
    { name: 'Bhavya Singhal', class: 'Class X', year: '2025-26', percentage: 92.33, imageUrl: null },
    { name: 'Prathvi Nagar', class: 'Class X', year: '2025-26', percentage: 92.33, imageUrl: null },
    { name: 'Ananya Saini', class: 'Class X', year: '2025-26', percentage: 92.00, imageUrl: null },
    { name: 'Uday Kumar Shakya', class: 'Class X', year: '2025-26', percentage: 92.00, imageUrl: null },
    { name: 'Gopesh Mehra', class: 'Class X', year: '2025-26', percentage: 91.67, imageUrl: null },
    { name: 'Aarushi Hada', class: 'Class X', year: '2025-26', percentage: 90.83, imageUrl: null },
    { name: 'Tushant Nagar', class: 'Class X', year: '2025-26', percentage: 89.83, imageUrl: null },
    { name: 'Bhavesh Gautam', class: 'Class X', year: '2025-26', percentage: 88.83, imageUrl: null },
    { name: 'Samiksha Meena', class: 'Class X', year: '2025-26', percentage: 88.83, imageUrl: null },
    { name: 'Radhika Meena', class: 'Class X', year: '2025-26', percentage: 87.17, imageUrl: null },
    { name: 'Vaidehi Malav', class: 'Class X', year: '2025-26', percentage: 87.00, imageUrl: null },
    { name: 'Pawan Kumawat', class: 'Class X', year: '2025-26', percentage: 86.83, imageUrl: null },
    { name: 'Kusum Dhakad', class: 'Class X', year: '2025-26', percentage: 86.50, imageUrl: null },
    { name: 'Bhavesh Dhakad', class: 'Class X', year: '2025-26', percentage: 86.17, imageUrl: null },
    { name: 'Kanishka Suman', class: 'Class X', year: '2025-26', percentage: 85.50, imageUrl: null },
    { name: 'Yashasvi Nagar', class: 'Class X', year: '2025-26', percentage: 84.33, imageUrl: null },
    { name: 'Prachi Nagar', class: 'Class X', year: '2025-26', percentage: 83.83, imageUrl: null },
    { name: 'Akshara Nagar', class: 'Class X', year: '2025-26', percentage: 82.67, imageUrl: null },
    { name: 'Ishika Mahavar', class: 'Class X', year: '2025-26', percentage: 81.83, imageUrl: null },
    { name: 'Akshara Panwar', class: 'Class X', year: '2025-26', percentage: 80.33, imageUrl: null },
  ];
